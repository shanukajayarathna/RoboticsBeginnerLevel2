...
-- ---------------------------------------------------------------------
-- MOCK EXAM (Level 2): editable question bank + per-student submissions.
-- Run once in the Supabase SQL Editor. Safe to re-run (see
-- supabase_mock_exam.sql for the same script on its own).
-- ---------------------------------------------------------------------
